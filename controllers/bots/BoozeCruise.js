            ...
            if (req.body.message.text == "/start") {
              ...
              Port.findOne({
                ...
                if (ship.nextLocation) {
                  b.sendKeyboard(ship.id, "Your ship is now en route to " + ship.nextLocation.port + "\nyou will arrive in " + calculateDistance(port.location, ship.nextLocation) + " hours", keyboard.atSea);
                } else {
